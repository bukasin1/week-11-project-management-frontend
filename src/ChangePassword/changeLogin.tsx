        ...
        <div className="change-container">
         <form className="change-password" onSubmit={handleSubmit} >
             <div className="change-inputs">
                 ...
                 <br/>
                 <input id='Password' type='password' name='oldPassword' className='change-input' value= {values.oldPassword} onChange={handleChange}/>
             ...
             <div className="change-inputs">
                 ...
                 <br/>
                 <input id='password' type='password' name='newPassword' className='change-input' value= {values.newPassword} onChange={handleChange}/>
             ...
             <div className="change-inputs">
                 ...
                 <br/>
                 <input id='password' type='password' name='repeatPassword' className='change-input' value= {values.repeatPassword} onChange={handleChange}/>
