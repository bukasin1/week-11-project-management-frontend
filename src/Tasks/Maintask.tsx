...
import videoimg from "./MaintaskImag/pdf.svg"
    ...
    return (
        <div className="maintask-content">
         <div className="maintask-header">
          ...
          <img src = {Avater1} className = 'maintask-avarter' /><h4 className="m3rdHeader0">Linzeli Bownman</h4>
          </div>
          <h4 className="m3rdHeader1">Tues, Dec 25</h4>
          <h4 className="m3rdHeader2">MARKETING</h4>
          <h4 className="m3rdHeader3"><img src = {Avater1} className = 'maintask-avarter' /><img src = {Avater2} className = 'maintask-avarter' /><img src = {Avater1} className = 'maintask-avarter' /><img src = {Avater2} className = 'maintask-avarter' /></h4>
          ...
          <p>159 KB<span className="dele">Delete</span> </p> 
          </div>
          </div> 
          ...
          <div className="download-pdf">
           <p className="maintask-6rdHeader">Redesign Brief 2019.pdf</p>
          <div className="maintask-7rdHeader">
          <p className="size-content">159 KB<span className="dele">Delete</span> </p> 
          </div>
          </div> 
        ...
        <img src = {vergo} className = 'maintask-comment1' />
          ...
          <input id='email' type='name' name='email' className='maintask-input' placeholder='Add a comment…'   />
        </div>
        <div className="img-content1">
        <img src = {mick} className = 'maintask-comment' />
        </div>
        <div className="maintask-9rdHeader">
       <p className="main4">Helena Brauer,<span className="main41" >Designer</span></p> <p className="main41">Yesterday at 12:37pm</p>
        </div>
       < div className="maintask-10rdHeader">
        <p className="main5">During a project build, it is necessary to evaluate the product design and development against project requirements and outcomes</p>
        </div>
        <div className="img-content1">
        <img src = {terus} className = 'maintask-comment' />
        </div>
        <div className="maintask-9rdHeader">
        <p className="main4">Prescott MacCaffery,<span className="main41" >Developer</span></p> <p className="main41">Yesterday at 12:37pm</p>
        </div>
       < div className="maintask-10rdHeader">
        <p className="main5">@Helena Software quality assurance activity in which one or several humans check a program mainly </p>
        </div>
        </div>
    )
}
